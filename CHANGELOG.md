...
- **docs: Control Center pointers name the monorepo (cc#169).** `CLAUDE.md`'s related-projects table and the `README.md` intro still linked the two split repos archived in cc#19; both now name `jgperrin/ai.jgp.controlcenter`. Docs-only.
