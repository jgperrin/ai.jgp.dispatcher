...
### Fixed
- ZipBuilder: safety-net normalization ensures contract version in ZIP has `v` prefix

## [0.4.1] - 2026-03-06

### Added
- Comprehensive end-to-end process documentation in README.md covering all 6 stages: user publish, GitHub Actions trigger, change detection, ZIP building, Zeenea upload, and Kafka publishing.
- Mermaid sequence diagram showing the full pipeline from Workbench UI to Zeenea and Kafka.
- Documented both operating modes (directory mode and file mode) with examples.
